...
<html lang="en">
  <head>
    ...
    <link rel = "stylesheet" type="text/css" href={{asset("css/stylesheet.css")}} /><!-- Link for header  stylesheet -->
    <link rel = "stylesheet" type="text/css" href={{asset("css/logincss.css")}} /> <!-- Link for the header styles -->
</head>

<!-- Header Section (unchanged, linked to stylesheet.css) -->
<header class="main-header">
    <div class="container">
        <a href="home.php"><img src={{asset("images/FatherboardTransparentCrop.png")}} id="logo" alt="FatherBoard Logo" width="100" height="50"></a>
